...
const partnerLifeClaimSchema = new mongoose.Schema({
 ...
 const PartnerLifeClaim = mongoose.model("PartnerLifeClaim",partnerLifeClaimSchema)
 module.exports = PartnerLifeClaim
...
const connectB2CDB = require("../config/b2c.DbConn");

const b2cUserSchema = new mongoose.Schema({
...
const b2cDB = connectB2CDB();
const B2CUser = b2cDB.model("B2CUser", b2cUserSchema);

module.exports = B2CUser;

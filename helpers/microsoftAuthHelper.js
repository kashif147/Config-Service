...
// const CODE_VERIFIER =
//   "9f~5TUNl.1Ktv-0Qn2Z7miLDo4wFZAc~0ep4v7aLjQJkaKy7TMRuKe.B3lhzgIqf_rYjd4aur-vKN9IWwJgcd.siL_KxXO9bYLTnriOkCjPYDfLigBWJQ7VDPdYUJA2t"; // Use actual verifier
...
//     console.log("inding or creating user");
...
//     try {
//       let user = await MSUser.findOne({ userEmail: email }); ////////////////////////////////////////////B2CUser
...
//         user.set(update);
//       } else {
//         user = new MSUser(update); ////////////////////////////////////////////B2CUser
//       }
...
//   static async handleMicrosoftAuth(code) {
